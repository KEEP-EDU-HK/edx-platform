...
def saml_metadata_view(request):
    ...
    objSingleLogoutService = ET.Element("md:SingleLogoutService", Binding = "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect", Location = "https://edx.keep.edu.hk/logout/redirect/", index = "2")
    ...
    #objAssertionService.attrib['Location'] = 'https://edx.keep.edu.hk/auth/complete/tpa-saml/'
