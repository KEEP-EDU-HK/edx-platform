...
def SSO_Logout(request):
    ...
    config['sp']['entityId'] = 'https://edx.keep.edu.hk/auth/saml/metadata.xml'
    config['sp']['assertionConsumerService']['url'] = 'https://edx.keep.edu.hk/'
    config['sp']['singleLogoutService'] = {'url':'https://edx.keep.edu.hk/', 'binding':'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect'}
    ...
    redirect_url = "https://edx.keep.edu.hk/"
    
    if request.GET.get('studio'): 
        redirect_url = "https://edxstudio.keep.edu.hk/"
